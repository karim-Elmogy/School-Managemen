            ...
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <input type="tel" wire:model="Phone_Father" class="form-control">
                        @error('Phone_Father')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" wire:model="Address_Father" id="exampleFormControlTextarea1" rows="2"></textarea>
                ...
                @if($updateMode)
                    <button class="btn btn-success nextBtn pull-right" wire:click="firstStepSubmit_edit"
