        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post"  action="{{ route('Students.store') }}" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2 SlectBox" name="Classroom_id">
                    ...
                    <button class="btn btn-success nextBtn  pull-right" type="submit">{{trans('Students_trans.submit')}}</button>
                </form>
